...
const Checkout = () => {
    ...
    useEffect(() => {
        // console.log("Entered Now into useEffect");
    ...
    <div className='py-14 min-h-[calc(100vh-100px)]'>
        ...
        {isLoading ? (
            ...
            <div className='mt-5'>
                ...
                {/* {console.log("Before the Summary: " + JSON.stringify(cart[0]))} */}
        ...
        <div
            ...
            {activeStep !== steps.length - 1 && (
                <button
                    ...
                    className={`bg-custom-blue font-semibold px-6 h-10 rounded-md text-slate-800
                       ${
                        errorMessage ||
                        (activeStep === 0 && !selectedUserCheckoutAddress) ||
                        (activeStep === 1 && !paymentMethod)
